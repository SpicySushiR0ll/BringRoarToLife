...
Our originial designs were inspired by other quadrapedal robots we found online from the likes of [Aaed Musa](https://www.youtube.com/watch?v=8s9TjRz01fo&t=389s) and [James Bruton](https://www.youtube.com/watch?v=yXA_KeuYpCY&t=652s). These quadrepeds were pretty big and used very robust motors. Our plans were to immitate this style of quadreped with stepper motors and a custom gear box assembly, however we were later advised (and rightfully so) to scale the design back as the stepper motors added a significant amount of weight not only by themselves, but also in the controllers neccesary to run them and the big batteries needed to power them. We then pivoted to sizing the robot down so that the chassis was about a foot in length and in standing height. We also pivoted to using servo motors. Non the less, i felt that my original gear box prototype was worthy of an inclusion here. 

![Dimensioned mini cyclodial drawing](https://github.com/user-attachments/assets/740f0745-6404-4880-96f8-17650750c524)

Inspired by the previously stated quardraped robots, I decided to design a cyclodial gearbox because of it low backlash and combact footprint. In order to design these cyclodial disks I made a crude class in java to derive the parametric equations defining the shape of the disks. It also calculated the necessary hole diameter based on the size of the disk and the size of the output shafts. The full java class will be included in this repository. The calculations were based on information provided by [StepByStep Robotics](https://stepbystep-robotics.com/hp/robots/cycloidal-drive/)  and [tec science](https://www.tec-science.com/mechanical-power-transmission/planetary-gear/construction-of-the-cycloidal-disc/)
...
I then printed out a couple of components to ensure sizing and fit with motor and bearings. Upon printing, concerns were raised about the strength of the eccentric cam as certain portion proved too small for the 0.4mm nozzel on my 3d printer. This resulted in portions of it not printing, however the cam did fit the output shaft of the motor and worked for sizing purposes. The strength of the guiding pins and output pins were also a cuase for concern as they had been printed vertically resulting in perpendicular print layers susceptible to shear faliures. I planed to aleviate the shear stress in at the base of these pins by filetting the edges resulting in more surface areas in theses regions and lowering shrear stress, however the gearbox solution was scraped before more iterations could be made. 
...
From this experience I had become very comforatable with the fusion workflow and my BambuLab slicer. These skills would carry foward into the next iteration of our animatronic's design. 
...
Note that the input shafts were still being design for stepper motors as that is what we had on hand to test with. More on the inverse kinamatics of the project and how we will control the movements in the IK.md section of this repository.

The next steps taken and where we are now is FEA analysis of out leg component. After inital tests showed stress concentration in the skinny upper link component and hip area of the leg. These were then thicken until FEA stress, strain, and displacement results were within an acceptable range.
...
The loading being done on the leg componentent was concentrated at the joint between the jeg and the servo motor mounted within the chassis of the animatronic. The load was 50 N divided by three in order to represent the leg being supporting by three legs while the fourth leg takes a step foward. While I do belive that these results are indicative of the leg assembly being strong enough to support the weight of the robot, more analysis needs to be done with loads being concentrated at the foot to simulate the normal force, dynamic forces being taken into account, and joints being side loaded to ensure that striping will not be a mode of faliure. I am still learning and becoming familar with FEA simulation in fusion. I will update this section as appropriate.

This is an overview of our current full assembly with shell, head, and tail components made by other memebers of my group. I also adjusted the chassis and arranged the placement of electronics in order to fit all neccesary components (our current build of matierals includes an arduino mega, 6 buck converters, and a 5200 mah battery mounted to the bottom of the chassis) and optimize airflow and ventalation.
